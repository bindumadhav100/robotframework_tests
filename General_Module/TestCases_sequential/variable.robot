...
${uploadFileLocation}             C:\\Users\\bmdesai\\eclipse-workspace\\AI_ML_Test_Execution_Framework\\ALICE\\Input_files
${caseClickElement}            //input[@id="mat-input-0"]
${caseIdInput}               //input[@id="mat-input-0"]
${caseClickButton}            (//button[@class="mat-button"])[2]
${groupRadioButtonClick}        //div[contains(text(),'Market India')]
...
@{StaticList}                           Bundle Processing - Completed          Parser Started        Rule Completed           ML Job Execution Completed
